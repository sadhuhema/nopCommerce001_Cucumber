...
public class AddCustomerPage {
	...
	//By custMenuLink=By.xpath("//p[contains(text(),'Customers')]");
	//By CustLink=By.xpath("//p[contains(text(),'Customers')]");
	By lnkCustomers_menu=By.xpath("//p[contains(text(),'Customers')]");
	By lnkCustomers_menuitem=By.xpath("//p[contains(text(),'Customers')]");
	
	By btnAddnew=By.xpath("//a[@class='btn btn-primary']"); //Add newclass="btn btn-primary"
